...
namespace edt::reflection
{
    ...
    public:
         ...
         */
        [[nodiscard]] virtual const Type* GetReturnType() const = 0;
         ...
         */
        [[nodiscard]] virtual const Type* GetObjectType() const = 0;

        /* Function parameters count
         */
        [[nodiscard]] virtual size_t GetArgumentsCount() const = 0;

        /* Function parameter type by index
         * index should be in range [0; GetArgumentsCount())
         */
        [[nodiscard]] virtual const Type* GetArgumentType(size_t index) const = 0;
