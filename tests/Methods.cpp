...
TEST(CppReflectionTest, Method_ReturnsVoidArgumentVoid) {
    ...
    EXPECT_TRUE(typeInfo->GetName() == "test_method_ret_void_arg_void::ReflectedType"sv);
    EXPECT_TRUE(typeInfo->GetInstanceSize() == sizeof(ReflectedType));
    EXPECT_TRUE(typeInfo->GetMethodsCount() == 1);
    const cppreflection::Function* functionInfo = typeInfo->GetMethod(0);
    EXPECT_TRUE(functionInfo != nullptr);
    EXPECT_TRUE(functionInfo->GetName() == "f1"sv);
    EXPECT_TRUE(functionInfo->GetObjectType() == typeInfo);
    EXPECT_TRUE(functionInfo->GetReturnType() == nullptr);
    EXPECT_TRUE(functionInfo->GetArgumentsCount() == 0);
...
TEST(CppReflectionTest, Method_ReturnsVoidArgumentInt) {
    ...
    const cppreflection::Type* typeInfo = cppreflection::GetTypeInfo<ReflectedType>();
    EXPECT_TRUE(typeInfo != nullptr);
    EXPECT_TRUE(typeInfo->GetName() == "test_method_ret_void_arg_int::ReflectedType"sv);
    EXPECT_TRUE(typeInfo->GetInstanceSize() == sizeof(ReflectedType));
    EXPECT_TRUE(typeInfo->GetMethodsCount() == 1);
    const cppreflection::Function* functionInfo = typeInfo->GetMethod(0);
    EXPECT_TRUE(functionInfo != nullptr);
    ...
    EXPECT_TRUE(functionInfo->GetObjectType() == typeInfo);
    EXPECT_TRUE(functionInfo->GetReturnType() == nullptr);
    EXPECT_TRUE(functionInfo->GetArgumentsCount() == 1);
    EXPECT_TRUE(functionInfo->GetArgumentType(0) == cppreflection::GetTypeInfo<int>());
...
TEST(CppReflectionTest, Method_ReturnsVoidArgumentIntPtr) {
    ...
    const cppreflection::Type* typeInfo = cppreflection::GetTypeInfo<ReflectedType>();
    EXPECT_TRUE(typeInfo != nullptr);
    EXPECT_TRUE(typeInfo->GetName() == "test_method_ret_void_arg_int_ptr::ReflectedType"sv);
    EXPECT_TRUE(typeInfo->GetInstanceSize() == sizeof(ReflectedType));
    EXPECT_TRUE(typeInfo->GetMethodsCount() == 1);
    const cppreflection::Function* functionInfo = typeInfo->GetMethod(0);
    EXPECT_TRUE(functionInfo != nullptr);
...
TEST(CppReflectionTest, Method_ReturnsVoidArgumentIntRef) {
    ...
    const cppreflection::Type* typeInfo = cppreflection::GetTypeInfo<ReflectedType>();
    EXPECT_TRUE(typeInfo != nullptr);
    EXPECT_TRUE(typeInfo->GetName() == "test_method_ret_void_arg_int_ref::ReflectedType"sv);
    EXPECT_TRUE(typeInfo->GetInstanceSize() == sizeof(ReflectedType));
    EXPECT_TRUE(typeInfo->GetMethodsCount() == 1);
    const cppreflection::Function* functionInfo = typeInfo->GetMethod(0);
    EXPECT_TRUE(functionInfo != nullptr);
...
TEST(CppReflectionTest, Method_ReturnsVoidArgumentIntPtrRef) {
    ...
    const cppreflection::Type* typeInfo = cppreflection::GetTypeInfo<ReflectedType>();
    EXPECT_TRUE(typeInfo != nullptr);
    EXPECT_TRUE(typeInfo->GetName() == "test_method_ret_void_arg_int_ptr_ref::ReflectedType"sv);
    EXPECT_TRUE(typeInfo->GetInstanceSize() == sizeof(ReflectedType));
    EXPECT_TRUE(typeInfo->GetMethodsCount() == 1);
    const cppreflection::Function* functionInfo = typeInfo->GetMethod(0);
    EXPECT_TRUE(functionInfo != nullptr);
...
TEST(CppReflectionTest, Method_ReturnsVoidArgumentRValue) {
    ...
    EXPECT_TRUE(functionInfo->GetReturnType() == nullptr);
    EXPECT_TRUE(functionInfo->GetArgumentsCount() == 1);
    EXPECT_TRUE(functionInfo->GetArgumentType(0) == cppreflection::GetTypeInfo<MovableType&&>());
...
TEST(CppReflectionTest, Method_ReturnsIntArgumentVoid) {
    ...
    const cppreflection::Type* typeInfo = cppreflection::GetTypeInfo<ReflectedType>();
    EXPECT_TRUE(typeInfo != nullptr);
    EXPECT_TRUE(typeInfo->GetName() == "test_method_ret_int::ReflectedType"sv);
    EXPECT_TRUE(typeInfo->GetInstanceSize() == sizeof(ReflectedType));
    EXPECT_TRUE(typeInfo->GetMethodsCount() == 1);
    const cppreflection::Function* functionInfo = typeInfo->GetMethod(0);
    EXPECT_TRUE(functionInfo != nullptr);
...
TEST(CppReflectionTest, Method_ReturnsIntPtrArgumentVoid) {
    ...
    const cppreflection::Type* typeInfo = cppreflection::GetTypeInfo<ReflectedType>();
    EXPECT_TRUE(typeInfo != nullptr);
    EXPECT_TRUE(typeInfo->GetName() == "test_method_ret_int_ptr::ReflectedType"sv);
    EXPECT_TRUE(typeInfo->GetInstanceSize() == sizeof(ReflectedType));
    EXPECT_TRUE(typeInfo->GetMethodsCount() == 1);
    const cppreflection::Function* functionInfo = typeInfo->GetMethod(0);
    EXPECT_TRUE(functionInfo != nullptr);
...
TEST(CppReflectionTest, Method_ReturnsIntRefArgumentVoid) {
    ...
    const cppreflection::Type* typeInfo = cppreflection::GetTypeInfo<ReflectedType>();
    EXPECT_TRUE(typeInfo != nullptr);
    EXPECT_TRUE(typeInfo->GetName() == "test_method_ret_int_ref::ReflectedType"sv);
    EXPECT_TRUE(typeInfo->GetInstanceSize() == sizeof(ReflectedType));
    EXPECT_TRUE(typeInfo->GetMethodsCount() == 1);
    const cppreflection::Function* functionInfo = typeInfo->GetMethod(0);
    EXPECT_TRUE(functionInfo != nullptr);
...
TEST(CppReflectionTest, Method_ReturnsIntPtrRefArgumentVoid) {
    ...
    const cppreflection::Type* typeInfo = cppreflection::GetTypeInfo<ReflectedType>();
    EXPECT_TRUE(typeInfo != nullptr);
    EXPECT_TRUE(typeInfo->GetName() == "test_method_ret_int_ptr_ref::ReflectedType"sv);
    EXPECT_TRUE(typeInfo->GetInstanceSize() == sizeof(ReflectedType));
    EXPECT_TRUE(typeInfo->GetMethodsCount() == 1);
    const cppreflection::Function* functionInfo = typeInfo->GetMethod(0);
    EXPECT_TRUE(functionInfo != nullptr);
...
TEST(CppReflectionTest, Method_ReturnsRValueArgumentVoid) {
    ...
    const cppreflection::Type* typeInfo = cppreflection::GetTypeInfo<ReflectedType>();
    EXPECT_TRUE(typeInfo != nullptr);
    EXPECT_TRUE(typeInfo->GetName() == "test_method_ret_rvalue::ReflectedType"sv);
    EXPECT_TRUE(typeInfo->GetInstanceSize() == sizeof(ReflectedType));
    EXPECT_TRUE(typeInfo->GetMethodsCount() == 1);
    const cppreflection::Function* functionInfo = typeInfo->GetMethod(0);
    EXPECT_TRUE(functionInfo != nullptr);
...
TEST(CppReflectionTest, Method_ReturnsVoidArgumentClassType) {
    ...
    const cppreflection::Type* typeInfo = cppreflection::GetTypeInfo<ReflectedType>();
    EXPECT_TRUE(typeInfo != nullptr);
    EXPECT_TRUE(typeInfo->GetName() == "test_method_ret_void_arg_same_type_ref::ReflectedType"sv);
    EXPECT_TRUE(typeInfo->GetInstanceSize() == sizeof(ReflectedType));
    EXPECT_TRUE(typeInfo->GetMethodsCount() == 1);
    const cppreflection::Function* functionInfo = typeInfo->GetMethod(0);
    EXPECT_TRUE(functionInfo != nullptr);
    ...
    EXPECT_TRUE(functionInfo->GetReturnType() == nullptr);
    EXPECT_TRUE(functionInfo->GetArgumentsCount() == 1);
    EXPECT_TRUE(functionInfo->GetArgumentType(0) == cppreflection::GetTypeInfo<ReflectedType&>());
