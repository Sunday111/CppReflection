...
class TypeImpl : public Type {
 public:
  ...
  virtual void SetAlignment(size_t alignment) override {
  ...
  virtual void SetSpecialMembers(
      const TypeSpecialMembers& specialMembers) override;
  virtual const TypeSpecialMembers& GetSpecialMembers() const override;
  virtual void SetComparisonOperators(
      const TypeComparisonOperators& comparisonOperators) override;
  virtual const TypeComparisonOperators& GetComparisonOperators()
      const override;
