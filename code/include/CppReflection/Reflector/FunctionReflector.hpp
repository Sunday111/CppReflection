...
private:
    ...
    template <size_t... Index>
    static void
    Call_i(void* Object, void* ReturnValue, void** ArgsArray, size_t ArgsArraySize, std::index_sequence<Index...>);
...
{
    Call_i(Object, ReturnValue, ArgsArray, ArgsArraySize, std::make_index_sequence<Signature::GetArgsCount()>());
}
...
template <auto pfn>
template <size_t... Index>
void FunctionReflector<pfn>::Call_i(
    void* Object,
